...
if ( ! function_exists( 'astra_setup' ) ) :
/**
...
function astra_setup() {
	 ...
	 * If you're building a theme based on astra, use a find and replace
 ...
 */
function astra_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'astra_content_width', 640 );
}
add_action( 'after_setup_theme', 'astra_content_width', 0 );
